...
![Mockup image](assets/documents/responsive.png)
...
![Start Drawing Button](assets/documents/start-button.png)
![Effect](assets/documents/effect-button.png)
...
![Instructions Popup Button](assets/documents/instructions-button.png)
![Effect](assets/documents/effect-btn.png)
![Popup Text](assets/documents/instr-text.png)

> Quoted Text

In the middle of the page it's a quoted text, to give encouragement.

![Quoted Text](assets/documents/quote.png)

> Cube Hover Effect

I created an colorful cube with hover effect, just for fun.
The code for creating this cube it's from youtube, the source it's [here](https://www.youtube.com/watch?v=oc2S3Wo-I1A&t=400s).

![Cube](assets/documents/cube.png)

![Cube With Effect](assets/documents/cube-effect.png)
...
![Header of Canva](assets/documents/header-canva.png)
...
![Clear Button](assets/documents/clear-button.png)

> Save Button

There is a "Save" button witch will save what the user have drawed.

![Save Button](assets/documents/save-button.png)

> Changing Background

There is an input for changing the background color to make the drawing more fun.

![Button](assets/documents/input.png)
![When Clikecd](assets/documents/input-clicked.png)
![Background Changed](assets/documents/background-changed.png)
